...
!function (a) {
    ...
    var d = {top: 0, bottom: 0, clsactive: "uk-active", clswrapper: "uk-sticky", getWidthFrom: ""}, e = b(window),
        f = b(document), g = [], h = e.height(), i = function () {
            ...
            init: function (a) {
                ...
                return this.each(function () {
                    var a = b(this);
                    if (!a.data("sticky")) {
                        var d = a.attr("id") || "s" + Math.ceil(1e4 * Math.random()),
